...
import type { TranscriptionExportTxtService } from "../services/transcription-export-txt.service.js";

/** `POST /api/transcription/tasks/:id/export/txt` Controller。 */
export class TranscriptionTaskExportTxtController {
  constructor(
    private readonly exportService: TranscriptionExportTxtService,
  ...
  async handle(
    ...
    const data = await this.exportService.exportTxt(
      ctx.auth,
      ctx.accessToken,
      params.id,
